...
if ( !function_exists( 'cars4rent_template_news_portfolio_theme_setup' ) ) {
	add_action( 'cars4rent_action_before_init_theme', 'cars4rent_template_news_portfolio_theme_setup', 1 );
	function cars4rent_template_news_portfolio_theme_setup() {
		cars4rent_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'cars4rent'),
...
// Template output
if ( !function_exists( 'cars4rent_template_news_portfolio_output' ) ) {
	function cars4rent_template_news_portfolio_output($post_options, $post_data) {
