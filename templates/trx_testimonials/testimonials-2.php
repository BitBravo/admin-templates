...
if ( !function_exists( 'cars4rent_template_testimonials_2_theme_setup' ) ) {
	add_action( 'cars4rent_action_before_init_theme', 'cars4rent_template_testimonials_2_theme_setup', 1 );
	function cars4rent_template_testimonials_2_theme_setup() {
		cars4rent_add_template(array(
			'layout' => 'testimonials-2',
			'template' => 'testimonials-2',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 2/', 'cars4rent')
		));
	}
}

// Template output
if ( !function_exists( 'cars4rent_template_testimonials_2_output' ) ) {
	function cars4rent_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
