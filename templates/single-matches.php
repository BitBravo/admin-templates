...
if ( !function_exists( 'cars4rent_template_single_matches_theme_setup' ) ) {
	add_action( 'cars4rent_action_before_init_theme', 'cars4rent_template_single_matches_theme_setup', 1 );
	function cars4rent_template_single_matches_theme_setup() {
		cars4rent_add_template(array(
			'layout' => 'single-matches',
			'mode'   => 'single_matches',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single matches', 'cars4rent'),
...
// Template output
if ( !function_exists( 'cars4rent_template_single_matches_output' ) ) {
	function cars4rent_template_single_matches_output($post_options, $post_data) {
