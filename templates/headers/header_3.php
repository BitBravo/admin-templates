...
if ( !function_exists( 'cars4rent_template_header_3_theme_setup' ) ) {
	add_action( 'cars4rent_action_before_init_theme', 'cars4rent_template_header_3_theme_setup', 1 );
	function cars4rent_template_header_3_theme_setup() {
		cars4rent_add_template(array(
			'layout' => 'header_3',
			'mode'   => 'header',
			'title'  => esc_html__('Header 3', 'cars4rent'),
			'icon'   => cars4rent_get_file_url('templates/headers/images/3.jpg')
			));
	}
}

// Template output
if ( !function_exists( 'cars4rent_template_header_3_output' ) ) {
	function cars4rent_template_header_3_output($post_options, $post_data) {
		...
		<header class="top_panel_wrap top_panel_style_3 scheme_<?php echo esc_attr($post_options['scheme']); ?>">
			<div class="top_panel_wrap_inner top_panel_inner_style_3 top_panel_position_<?php echo esc_attr(cars4rent_get_custom_option('top_panel_position')); ?>">
			
			<?php if (cars4rent_get_custom_option('show_top_panel_top')=='yes') { ?>
			...
			<div class="top_panel_middle" <?php cars4rent_show_layout($header_css); ?>>
				<div class="content_wrap">
					<div class="contact_logo">
						<?php cars4rent_show_logo(true, true); ?>
					</div>
