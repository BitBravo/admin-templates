...
if ( !function_exists( 'cars4rent_template_matches_2_theme_setup' ) ) {
	add_action( 'cars4rent_action_before_init_theme', 'cars4rent_template_matches_2_theme_setup', 1 );
	function cars4rent_template_matches_2_theme_setup() {
		cars4rent_add_template(array(
			'layout' => 'matches-2',
			'template' => 'matches-2',
			'mode'   => 'matches',
			'title'  => esc_html__('Matches /Style 2/', 'cars4rent'),
...
// Template output
if ( !function_exists( 'cars4rent_template_matches_2_output' ) ) {
	function cars4rent_template_matches_2_output($post_options, $post_data) {
		$show_title = true;
